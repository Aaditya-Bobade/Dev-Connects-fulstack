...
"[project]/src/components/threads/threads-home.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ThreadsHomePage() {
    ...
    const [activeCategory, setActiveCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(searchParams.get("category") ?? "all");
        ...
        async function load() {
            try {
                ...
                const [extractCategories, extractThreads] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])(apiClient, "/api/threads/categories"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])(apiClient, "/api/threads/threads", {
                        params: {
    ...
    async function applyFilters(currentCategoryVal, currentSearchVal) {
        ...
        setIsLoading(true);
        try {
            const threadListAfterSearchFilters = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGet"])(apiClient, "/api/threads/threads", {
                params: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c38e290._.js.map